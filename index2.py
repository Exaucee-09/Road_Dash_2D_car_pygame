...
player_car8_path = os.path.join(os.getcwd(), 'img/bmw-vision-8.png')
player_car9_path = os.path.join(os.getcwd(), 'img/bmw_i8-fotor.png')
...
enemy_car5_path = os.path.join(os.getcwd(), 'img/bmw_m5.png')
bust_path = os.path.join(os.getcwd(), 'img/fire1.png')
...
class CarRacing:
    def __init__(self):
        ...
        self.crashed = False
        #
        self.bust, self.bus_width, self.bust_height = scale_car(bust_path)
        # Locating points
        self.m_right = int(self.display_width * (4 / 5) - 90)
        self.m_left = int(self.display_width * (1 / 5) + 40)
        self.count = 0
    ...
    def detect_collisions(self):
        ...
        if self.enemy_car_start_y <= self.car_y_coordinate <= (self.enemy_car_start_y + self.enemy_car_height - 30):
            if self.enemy_car_start_x <= self.car_x_coordinate <= (self.enemy_car_start_x + self.enemy_car_width) or \
                ...
                self.crashed = True
                self.gameDisplay.blit(self.bust, (self.car_x_coordinate, self.car_y_coordinate - 40))
    ...
    def change_vehicle(self):
        if self.count < 2000 or self.count > 5000:
            if self.count > 6000 and self.count % 2 == 0:
                self.player_car, self.scaled_car_width, car_height = scale_car(player_car2_path)
            elif self.count > 6000 and self.count % 3 == 0:
                self.player_car, self.scaled_car_width, car_height = scale_car(player_car9_path)
            elif self.count % 3 == 0:
    ...
    def score_reward_vehicle(self):
        if self.count == 5000:
            ...
            self.player_car, self.scaled_car_width, car_height = scale_car(player_car8_path)
            self.enemy_car, self.enemy_car_width, self.enemy_car_height = scale_car(enemy_car1_path)
        elif self.count == 1000:
            self.enemy_car, self.enemy_car_width, self.enemy_car_height = scale_car(enemy_car5_path)
    ...
    def highscore_and_speed(self):
        ...
        text = font.render("Scores : " + str(self.count), True, (100, 200, 100))
        text1 = font2.render("Your Records", True, (255, 255, 255))
        text2 = font0.render(f"High Scores: {self.h_scores}", True, (160, 255, 160))
        text3 = font0.render(f"Last Scores : {self.l_scores}", True, (160, 160, 255))
        ...
        self.gameDisplay.blit(text1, (5, 640))
        self.gameDisplay.blit(text2, (5, 680))
        self.gameDisplay.blit(text3, (5, 710))
        ...
        self.gameDisplay.blit(menu_text, (10, 50))
        self.gameDisplay.blit(speed_text, (50, 80))
        if self.count in increase_speed:
            self.bg_speed += float(self.count / 1000.0)
            self.enemy_car_speed += 1 + float(self.count / 1000.0)
