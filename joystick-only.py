...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.scaled_bg_img = pygame.transform.scale(self.bgImg, (self.bg_img_width, self.bg_img_height))
    ...
    def run_car(self):
        ...
        while not self.crashed:
            ...
            if arduino_data == 1:
                self.car_y_coordinate -= 10  # Move forward
            elif arduino_data == 2:
                self.car_y_coordinate += 10  # Move backward
            elif arduino_data == 3:
                self.car_x_coordinate -= 10  # Move left
            elif arduino_data == 4:
                    self.car_x_coordinate += 10  # Move right
            #Keyboard maps
